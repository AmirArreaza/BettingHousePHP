...
abstract class BaseCategoria extends BaseObject  implements Persistent {
  ...
  const PEER = 'CategoriaPeer';
	...
	/**
	 * The value for the nombrecategoria field.
	 * @var        string
	 */
	...
	/**
	 * Get the [nombrecategoria] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Set the value of [nombrecategoria] column.
	 * 
	 * @param      string $v new value
	 * @return     Categoria The current object (for fluent API support)
	 */
	public function setNombrecategoria($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->nombrecategoria !== $v) {
			$this->nombrecategoria = $v;
			$this->modifiedColumns[] = CategoriaPeer::NOMBRECATEGORIA;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->nombrecategoria = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->resetModified();
			...
			return $startcol + 2; // 2 = CategoriaPeer::NUM_COLUMNS - CategoriaPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getNombrecategoria(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setNombrecategoria($arr[$keys[1]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CategoriaPeer::NOMBRECATEGORIA)) $criteria->add(CategoriaPeer::NOMBRECATEGORIA, $this->nombrecategoria);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setNombrecategoria($this->nombrecategoria);
	 ...
	 * related Eventos from storage. If this Categoria is new, it will return
		...
		if ($this->collEventos === null) {
			if ($this->isNew()) {
			   $this->collEventos = array();
				...
				$criteria->add(EventoPeer::FKCATEGORIA, $this->id);
