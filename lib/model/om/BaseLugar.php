...
abstract class BaseLugar extends BaseObject  implements Persistent {
  ...
  const PEER = 'LugarPeer';
	...
	/**
	 * The value for the avenida field.
	 * @var        string
	 */
	protected $avenida;
	...
	/**
	 * The value for the casa field.
	 * @var        int
	 */
	protected $casa;

	/**
	 * The value for the edificio field.
	 * @var        string
	 */
	protected $edificio;

	/**
	 * The value for the apartamento field.
	 * @var        int
	 */
	...
	/**
	 * Get the [apartamento] column value.
	 * 
	 * @return     int
	 */
	...
	public function setCiudad($v)
	{
		...
		if ($this->ciudad !== $v) {
			$this->ciudad = $v;
			$this->modifiedColumns[] = LugarPeer::CIUDAD;
		}
	...
	public function setEstado($v)
	{
		...
		if ($this->estado !== $v) {
			$this->estado = $v;
			$this->modifiedColumns[] = LugarPeer::ESTADO;
		}
	...
	public function setPais($v)
	{
		...
		if ($this->pais !== $v) {
			$this->pais = $v;
			$this->modifiedColumns[] = LugarPeer::PAIS;
		}
	...
	/**
	 * Set the value of [avenida] column.
	 * 
	 * @param      string $v new value
	 * @return     Lugar The current object (for fluent API support)
	 */
	public function setAvenida($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
		...
		if ($this->avenida !== $v) {
			$this->avenida = $v;
			$this->modifiedColumns[] = LugarPeer::AVENIDA;
		}
	...
	public function setCalle($v)
	{
		...
		if ($this->calle !== $v) {
			$this->calle = $v;
			$this->modifiedColumns[] = LugarPeer::CALLE;
		}
	...
	/**
	 * Set the value of [casa] column.
	 * 
	 * @param      int $v new value
	 * @return     Lugar The current object (for fluent API support)
	 */
	public function setCasa($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}
		...
		if ($this->casa !== $v) {
			$this->casa = $v;
			$this->modifiedColumns[] = LugarPeer::CASA;
		}
	...
	/**
	 * Set the value of [edificio] column.
	 * 
	 * @param      string $v new value
	 * @return     Lugar The current object (for fluent API support)
	 */
	public function setEdificio($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
		...
		if ($this->edificio !== $v) {
			$this->edificio = $v;
			$this->modifiedColumns[] = LugarPeer::EDIFICIO;
		}
	...
	/**
	 * Set the value of [apartamento] column.
	 * 
	 * @param      int $v new value
	 * @return     Lugar The current object (for fluent API support)
	 */
	public function setApartamento($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->apartamento !== $v) {
			$this->apartamento = $v;
			$this->modifiedColumns[] = LugarPeer::APARTAMENTO;
		}
	...
	public function setExpiresAt($v)
	{
		...
		if ( $this->expires_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = LugarPeer::EXPIRES_AT;
			}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = LugarPeer::CREATED_AT;
			}
		} // if either are not null
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = LugarPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->ciudad = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->estado = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->pais = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->avenida = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->calle = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->casa = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
			$this->edificio = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->apartamento = ($row[$startcol + 8] !== null) ? (int) $row[$startcol + 8] : null;
			...
			return $startcol + 12; // 12 = LugarPeer::NUM_COLUMNS - LugarPeer::NUM_LAZY_LOAD_COLUMNS).
    ...
    if ($this->isNew() && !$this->isColumnModified(LugarPeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
    }

    if ($this->isModified() && !$this->isColumnModified(LugarPeer::UPDATED_AT))
    {
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = LugarPeer::doInsert($this, $con);
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[3] => $this->getPais(),
			$keys[4] => $this->getAvenida(),
			$keys[5] => $this->getCalle(),
			$keys[6] => $this->getCasa(),
			$keys[7] => $this->getEdificio(),
			$keys[8] => $this->getApartamento(),
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 6:
				...
				break;
			case 7:
				$this->setEdificio($value);
				break;
			case 8:
				$this->setApartamento($value);
				break;
			case 9:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setCiudad($arr[$keys[1]]);
		if (array_key_exists($keys[2], $arr)) $this->setEstado($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setPais($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setAvenida($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setCalle($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setCasa($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setEdificio($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setApartamento($arr[$keys[8]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LugarPeer::CIUDAD)) $criteria->add(LugarPeer::CIUDAD, $this->ciudad);
		if ($this->isColumnModified(LugarPeer::ESTADO)) $criteria->add(LugarPeer::ESTADO, $this->estado);
		if ($this->isColumnModified(LugarPeer::PAIS)) $criteria->add(LugarPeer::PAIS, $this->pais);
		if ($this->isColumnModified(LugarPeer::AVENIDA)) $criteria->add(LugarPeer::AVENIDA, $this->avenida);
		if ($this->isColumnModified(LugarPeer::CALLE)) $criteria->add(LugarPeer::CALLE, $this->calle);
		if ($this->isColumnModified(LugarPeer::CASA)) $criteria->add(LugarPeer::CASA, $this->casa);
		if ($this->isColumnModified(LugarPeer::EDIFICIO)) $criteria->add(LugarPeer::EDIFICIO, $this->edificio);
		if ($this->isColumnModified(LugarPeer::APARTAMENTO)) $criteria->add(LugarPeer::APARTAMENTO, $this->apartamento);
		if ($this->isColumnModified(LugarPeer::EXPIRES_AT)) $criteria->add(LugarPeer::EXPIRES_AT, $this->expires_at);
		if ($this->isColumnModified(LugarPeer::CREATED_AT)) $criteria->add(LugarPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(LugarPeer::UPDATED_AT)) $criteria->add(LugarPeer::UPDATED_AT, $this->updated_at);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setAvenida($this->avenida);

		$copyObj->setCalle($this->calle);

		$copyObj->setCasa($this->casa);

		$copyObj->setEdificio($this->edificio);

		$copyObj->setApartamento($this->apartamento);
	 ...
	 * Otherwise if this Lugar has previously been saved, it will retrieve
	 * related Usuarios from storage. If this Lugar is new, it will return
		...
		if ($this->collUsuarios === null) {
			if ($this->isNew()) {
			   $this->collUsuarios = array();
				...
				$criteria->add(UsuarioPeer::FKLUGAR, $this->id);
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseLugar:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseLugar::%s', $method));
    }
