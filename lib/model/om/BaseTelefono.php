...
abstract class BaseTelefono extends BaseObject  implements Persistent {
  ...
  const PEER = 'TelefonoPeer';
	...
	public function setFkusuario($v)
	{
		...
		if ($this->fkusuario !== $v) {
			$this->fkusuario = $v;
			$this->modifiedColumns[] = TelefonoPeer::FKUSUARIO;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = TelefonoPeer::NUM_COLUMNS - TelefonoPeer::NUM_LAZY_LOAD_COLUMNS).
    ...
    foreach (sfMixer::getCallables('BaseTelefono:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			TelefonoPeer::doDelete($this, $con);
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = TelefonoPeer::doInsert($this, $con);
					...
					$affectedRows += TelefonoPeer::doUpdate($this, $con);
				}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TelefonoPeer::FKUSUARIO)) $criteria->add(TelefonoPeer::FKUSUARIO, $this->fkusuario);
	...
	public function getUsuario(PropelPDO $con = null)
	{
		if ($this->aUsuario === null && (($this->fkusuario !== "" && $this->fkusuario !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aUsuario->addTelefonos($this);
			 */
		}
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseTelefono:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseTelefono::%s', $method));
    }
