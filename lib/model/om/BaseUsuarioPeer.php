...
abstract class BaseUsuarioPeer {
	...
	/** the column name for the FKLUGAR field */
	const FKLUGAR = 'USUARIO.FKLUGAR';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Nick', 'Nombre', 'Apellido', 'Correo', 'Credito', 'Password', 'Estado', 'Fklugar', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('nick', 'nombre', 'apellido', 'correo', 'credito', 'password', 'estado', 'fklugar', ),
		BasePeer::TYPE_COLNAME => array (self::NICK, self::NOMBRE, self::APELLIDO, self::CORREO, self::CREDITO, self::PASSWORD, self::ESTADO, self::FKLUGAR, ),
		BasePeer::TYPE_FIELDNAME => array ('nick', 'nombre', 'apellido', 'correo', 'credito', 'password', 'estado', 'fkLugar', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Nick' => 0, 'Nombre' => 1, 'Apellido' => 2, 'Correo' => 3, 'Credito' => 4, 'Password' => 5, 'Estado' => 6, 'Fklugar' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('nick' => 0, 'nombre' => 1, 'apellido' => 2, 'correo' => 3, 'credito' => 4, 'password' => 5, 'estado' => 6, 'fklugar' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::NICK => 0, self::NOMBRE => 1, self::APELLIDO => 2, self::CORREO => 3, self::CREDITO => 4, self::PASSWORD => 5, self::ESTADO => 6, self::FKLUGAR => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('nick' => 0, 'nombre' => 1, 'apellido' => 2, 'correo' => 3, 'credito' => 4, 'password' => 5, 'estado' => 6, 'fkLugar' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(UsuarioPeer::CREDITO);

		$criteria->addSelectColumn(UsuarioPeer::PASSWORD);

		$criteria->addSelectColumn(UsuarioPeer::ESTADO);

		$criteria->addSelectColumn(UsuarioPeer::FKLUGAR);
	...
	public static function doCountJoinLugar(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(UsuarioPeer::FKLUGAR,), array(LugarPeer::ID,), $join_behavior);
	...
	/**
	 * Selects a collection of Usuario objects pre-filled with their Lugar objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinLugar(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
    ...
    foreach (sfMixer::getCallables('BaseUsuarioPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseUsuarioPeer', $c, $con);
		...
		LugarPeer::addSelectColumns($c);

		$c->addJoin(array(UsuarioPeer::FKLUGAR,), array(LugarPeer::ID,), $join_behavior);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Usuario) to $obj2 (Lugar)
      ...
      call_user_func($callable, 'BaseUsuarioPeer', $c, $con);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Usuario) to the collection in $obj2 (Lugar)
				$obj2->addUsuario($obj1);
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseUsuarioPeer:doUpdate:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(UsuarioPeer::NICK);
			$selectCriteria->add(UsuarioPeer::NICK, $criteria->remove(UsuarioPeer::NICK), $comparison);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(UsuarioPeer::NICK, (array) $values, Criteria::IN);
		...
		try {
			...
			// invalidate objects in UsuarioformapagoPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related Usuarioformapago objects
			$c = new Criteria(UsuarioformapagoPeer::DATABASE_NAME);
			
			$c->add(UsuarioformapagoPeer::FKUSUARIO, $obj->getNick());
			$affectedRows += UsuarioformapagoPeer::doDelete($c, $con);
		}
		return $affectedRows;
	}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(UsuarioPeer::NICK, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(UsuarioPeer::DATABASE_NAME);
			$criteria->add(UsuarioPeer::NICK, $pks, Criteria::IN);
